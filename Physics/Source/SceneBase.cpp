...
void SceneBase::Init()
{
	...
	meshList[GEO_ASTEROID]->textureID = LoadTGA("Image//bigasteroid.tga");
	meshList[GEO_BULLET] = MeshBuilder::GenerateSphere("bullet", Color(0.5, 0, 1), 10, 10, 1.f);
	meshList[GEO_BLACKHOLE] = MeshBuilder::GenerateSphere("blackhole", Color(0, 0, 0), 10, 10, 1.f);
	meshList[GEO_WHITEHOLE] = MeshBuilder::GenerateSphere("whitehole", Color(1, 1, 1), 10, 10, 1.f);
	meshList[GEO_TEXT] = MeshBuilder::GenerateText("text", 16, 16);
	meshList[GEO_TEXT]->textureID = LoadTGA("Image//calibri.tga");
	meshList[GEO_TEXT]->material.kAmbient.Set(1, 0, 0);
	meshList[GEO_PLAYER] = MeshBuilder::GenerateQuad("player", Color(1, 1, 1), 2.f);
